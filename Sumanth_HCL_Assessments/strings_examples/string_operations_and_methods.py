...
print(f"we can access range of characters using negative slicing like input_string[-4:-11] --> {input_string[-4:-11]}")
print(f"we can access range of characters using negative slicing like input_string[-4:-11:-1] --> {input_string[-4:-11:-1]}")
...
print(f"Given string is --> {input_string}")
print(f"length of given string is --> {len(input_string)}")
print(f"Given string in reverse order using input_string[::-1] --> {input_string[::-1]}")
print(f"Given string in reverse order using input_string[::-2] --> {input_string[::-2]}")
print(f"Given string in reverse order using input_string[::-3] --> {input_string[::-3]}\n")

print("---------------------------------------count of char-----------------------------------------------------------")
print(f"Given string is --> {input_string}")
print(f"length of given string is --> {len(input_string)}")
print(f"Count of particular character in the given string using input_string.count('i') --> {input_string.count('i')}")
print(f"Count of particular character in the given string using input_string.count('s') --> {input_string.count('s')}")
print(f"Count of particular character in the given string using input_string.count('P') --> {input_string.count('P')}\n")

print("----------------------------------------index of char---------------------------------------------------------")
print(f"Given string is --> {input_string}")
print(f"length of given string is --> {len(input_string)}")
print(f"index of particular character in the given string using input_string.index('P') --> {input_string.index('P')}")
print(f"index of particular character in the given string using input_string.index('i') --> {input_string.index('i')}")
print(f"index of particular character in the given string using input_string.index('D') --> {input_string.index('D')}")
print(f"index of particular character in the given string using input_string.find('D') --> {input_string.find('D')}")
print(f"index of particular character in the given string using input_string.find('h') --> {input_string.find('h')}")
print(f"index of particular character in the given string using input_string.find('m') --> {input_string.find('m')}\n")
...
print(f"strip of character at the start, end of given string using input_string.strip(' &') --> {sample_string.strip(' &')}")
print(f"strip of character at the start of the given string using input_string.rstrip(' &') --> {sample_string.rstrip(' &')}")
print(f"strip of character at the end of the given string using input_string.lstrip(' &') --> {sample_string.lstrip(' &')}\n")

print("------------------------------------split---------------------------------------------------------------------")
sample_string = " & This is Pycharm IDE & I am Pra@cticing Strings &"
print(f"Given string is --> {sample_string}")
print(f"length of given string is --> {len(sample_string)}")
print(f"split the given string using input_string.split() --> {sample_string.split()}")
# print(f"split of given string is input_string.split('') --> {input_string.split('')}")   # ValueError: empty separator
print(f"split the given string using input_string.split('&') --> {sample_string.split('&')}")
print(f"split the given string using input_string.split('is') --> {sample_string.split('is')}\n")
...
print(f"Join the splitted string using ''.join(sample_string) --> {''.join(sample_string)}")
print(f"Join the splitted string using ' '.join(sample_string) --> {' '.join(sample_string)}")
print(f"Join the splitted string using '*'.join(sample_string) --> {'*'.join(sample_string)}")
print("---------------------------------------------------------------------------------------------------------------")
